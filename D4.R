######Implementation of D4 for colon cancer data####
...
######Implementation of D4 for Leukemia cancer data####
...
######Implementation of D4 for lymphoma cancer data####
mrank<-function(x,xdata){
  n<-dim(xdata)[1]
  d<-dim(xdata)[2]
  s1<-0
...
######Implementation of D4 for postrate cancer data####
mrank<-function(x,xdata){
  n<-dim(xdata)[1]
  d<-dim(xdata)[2]
  s1<-0
...
######Implementation of D4 for SRBCT cancer data####
mrank<-function(x,xdata){
  n<-dim(xdata)[1]
  d<-dim(xdata)[2]
  s1<-0
